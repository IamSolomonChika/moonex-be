/**
 * MasterChef ABIs for PancakeSwap (Viem Compatible)
 * Provides ABI definitions for MasterChef V1 and V2 contracts
 */

// MasterChef V1 ABI
export const MASTERCHEF_V1_ABI = [
  {
    inputs: [
...
// MasterChef V2 ABI (simplified for now)
export const MASTERCHEF_V2_ABI = [
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'lastRewardBlock', type: 'uint256' },
      { internalType: 'uint256', name: 'accCakePerShare', type: 'uint256' },
      { internalType: 'uint256', name: 'rewarder', type: 'address' }
    ],
    stateMutability: 'view',
    type: 'function'
  },
