 ...
 */
function generateOpenAPISpec(): OpenAPIDocument {
 ...
 * Generate API paths
 */
function generateAPIPaths(): Record<string, any> {
  return {
    '/bsc/health': {
      get: {
        tags: ['health', 'bsc'],
 ...
 */
function generateResponses(): Record<string, any> {
  return {
    BadRequest: {
 ...
 * Generate examples
 */
function generateExamples(): Record<string, any> {
  return {
    TokenExample: {
 ...
 */
function generateHTMLDocumentation(spec: OpenAPIDocument, outputDir: string): void {
  // Swagger UI HTML
  const swaggerHTML = `
<!DOCTYPE html>
<html lang="en">
 ...
 */
function generatePostmanCollection(spec: OpenAPIDocument): any {
  const collection = {
    info: {
 ...
 */
function generateREADME(spec: OpenAPIDocument, outputDir: string): void {
 ...
 */
async function exportDocumentation(spec: OpenAPIDocument): Promise<void> {
